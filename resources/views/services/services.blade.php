...
<div class="container container-fluid">
    ...
    <div class="row">
            ...
            <table class="table">
                ...
                <tbody id="services-list" name="services-list">
                    ...
                    <tr id="service{{$services['data'][$i]['id']}}">
                        <td><a href="{{route('services.show', $services['data'][$i]['id'])}}" class="btn btn-primary btn-xs btn-detail service-info" value="{{$services['data'][$i]['id']}}">{{$services['data'][$i]['id']}}</button></td>
        ...
        <h2>Monitors</h2>
        <button id="btn-add" name="btn-add" class="btn btn-success btn-xs">Add Monitor</button>
        <div class="row">
            <div class="table-responsive">
                    <br />
                    <!-- Table-to-load-the-data Part -->
